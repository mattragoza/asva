...
Plum Boro,United States of America,40°27'N,79°43'W,US/Eastern
...
class Astral(object):
    ...
    def sunrise_utc(self, date, latitude, longitude):
        ...
        sunrise = datetime.datetime(date.year, date.month, date.day, hour%24, minute, second, tzinfo=pytz.utc)
    ...
    def sunset_utc(self, date, latitude, longitude):
        ...
        sunset = datetime.datetime(date.year, date.month, date.day, hour%24, minute, second, tzinfo=pytz.utc)
    ...
    def dusk_utc(self, date, latitude, longitude):
        ...
        dusk = datetime.datetime(date.year, date.month, date.day, hour%24, minute, second, tzinfo=pytz.utc)
